...
<div class="container mx-auto mt-10">
    <h2 class="text-2xl font-bold mb-4 text-center">Thùng rác</h2>
            ...
            <tbody class="text-sm font-medium text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 border-b border-gray-200">
                        ...
                        <!-- Khôi phục sản phẩm -->
                        @if($product->trashed())
                            <a href="{{ route('admin.products.restore', ['id' => $product->id]) }}" class="text-green-500 hover:underline ml-4" onclick="return confirm('Bạn có chắc chắn muốn khôi phục sản phẩm này?')">Khôi phục</a>
                        @endif
