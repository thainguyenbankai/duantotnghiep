            ...
            <tbody class="text-sm font-medium text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 border-b border-gray-200">
                        <a href="{{ route('admin.brands.edit', $brand->id) }}" class="text-blue-500 hover:underline">Sửa</a>
                        <form action="{{ route('admin.brands.destroy', $brand->id) }}" method="POST" class="inline-block ml-4">
                            @csrf
                            @method('DELETE')
